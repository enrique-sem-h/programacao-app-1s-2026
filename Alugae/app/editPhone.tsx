...
const styles = StyleSheet.create({
  ...
  row: { flexDirection: 'row', gap: 10, backgroundColor: 'transparent', marginTop: 5 },
  resendButton: { backgroundColor: '#E5E5E5', paddingHorizontal: 15, justifyContent: 'center', borderRadius: 12, height: 55 },
