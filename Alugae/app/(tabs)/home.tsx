...
export default function Home() {
  ...
  const anunciosFiltrados = categoriaSelecionada
    ? anuncios.filter((a) => a.categoria === categoriaSelecionada)
    : anuncios;
      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          <View style={styles.header}>
            <Image source={LogoAlugae} style={styles.logo} resizeMode="contain" />
          </View>
          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              const selecionada = categoriaSelecionada === item;
              return (
                <TouchableOpacity
                  style={[styles.categoriaChip, selecionada && styles.categoriaChipAtiva]}
                  onPress={() =>
                    setCategoriaSelecionada(selecionada ? null : item as Categoria)
                  }
                >
          ...
          <Text style={styles.sectionTitle}>
            {categoriaSelecionada ? categoriaSelecionada : "Novidades perto de você"}
          </Text>
          ...
          {error ? (
            ...
            <View style={styles.grid}>
              ...
              {!loading && anunciosFiltrados.length === 0 && !error && (
                <EmptyState
                  message={
                    categoriaSelecionada
                      ? `Nenhum anúncio em "${categoriaSelecionada}".`
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    marginTop: 20, marginBottom: 30, backgroundColor: "transparent",
  },
  logo: { width: 60, height: 60 },
  banner: {
    height: 180, backgroundColor: "#eee", borderRadius: 12,
    justifyContent: "center", alignItems: "center",
    marginBottom: 25, borderWidth: 1, borderColor: "#ddd",
  },
  bannerText: {
    marginTop: 10, color: "#666", fontWeight: "600",
  ...
  categoriaChipAtiva: { backgroundColor: "#007AFF" },
...
const states = StyleSheet.create({
  container: {
    ...
    paddingVertical: 40, backgroundColor: "transparent", gap: 12,
  },
